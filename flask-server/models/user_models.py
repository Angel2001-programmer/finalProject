...
class Profile(db.Model):
    ...
    user_id = db.Column(db.String(32), primary_key=True, unique=True, default=User.user_id)
    username = db.Column(db.String(30), db.ForeignKey(User.username), unique=True, nullable=False)  # Have to set a primary key, try making it primary here and FK in user_accounts?
